...
So, for steady retention, reconstruction quality of surface-based annotations is equivalent or inferior to column-based implementation.
...
Given this result, we next seek to assess the extent to which tilted or steady retention would be preferred in practice across possible evolutionary scenarios.
