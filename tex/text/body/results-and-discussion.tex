...
Notably, inner node loss improvement under surface-based implementation is seen in all treatments with byte-width differentiae, which are more prone to create artifactual unresolved polytomies that drive inner node loss (Figure \ref{fig:col-vs-surf} in our Code, Data, \& Materials; \citep{moreno2024supplemental}).
...
In contrast, tilted policy exhibits among the lowest inner node loss in all but six surveyed scenarios --- including all byte-differentia trials (Figure \ref{fig:steady-vs-tilted} in our Code, Data, \& Materials; \citep{moreno2024supplemental}).
