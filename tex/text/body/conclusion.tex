...
% As such, we provide packaged library software with easy-to-learn API design and thorough documentation.
...
% We would be very interested in collaborating to integrate hereditary stratigraphy instrumentation into other systems or to develop algorithm implementations for particular programming languages and runtime environments.
