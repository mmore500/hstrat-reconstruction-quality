\begin{figure*}
  ...
  \caption{%
   \textbf{Comparison of reconstruction quality between small and large downsample and population sizes under hybrid retention policy.}
    ...
    Experiments used hybrid retention policy with surface-based implementation.
  ...
  \label{fig:dsamp-popsize-scale-hybrid}
\end{figure*}
