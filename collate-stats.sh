...
set -e
set -o nounset
find "${HOME}/scratch/hstrat-reconstruction-quality/${RUNMODE}" -name 'a=stats*ext=.csv' | python3 -m joinem --progress ~/scratch/hstrat-reconstruction-quality/a=stats+ext=.pqt
EOF
