...
for stratum_retention_algo in "old-steady" "old-tilted" "new-hybrid" "new-steady" "new-tilted"; do

for condition in "export num_islands=1 num_niches=1 tournament_size=2" "export num_islands=64 num_niches=8 tournament_size=2"; do
